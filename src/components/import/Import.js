...
const Import=(props)=>{
    ...
    const Add=async(e,b)=>{
        ...
        v["average_rating"]=b.average_rating
        v["publisher"]=b.publisher
        v["language_code"]=b.language_code
        ...
        if(book.quantity<=30){
            ...
            if(res==="True"){
                ...
                alert("Could not import books more than 30")
        }
    }
                          ...
                          <div className="bele" onClick={(e)=>expand(e.target,ele)}>
                              ...
                              <div className="hid">
                                  ...
                                  <div className="subele">
                                        <div className="feild" >
                                            <input type="number" name="quantity" onChange={(e)=>updateFeild(e,"quantity")} placeholder="Quantity"></input>
                                        </div>
